  ...
  return (
    <div
      className={cn(
        ...
        "[&_h2]:mt-14 [&_h2]:mb-3 [&_h2]:border-t [&_h2]:border-line [&_h2]:pt-8 [&_h2]:font-[family-name:var(--font-display)] [&_h2]:text-[1.75rem] [&_h2]:font-normal [&_h2]:text-text-primary [&_h2]:scroll-mt-24 [&_h2:first-child]:mt-0 [&_h2:first-child]:border-0 [&_h2:first-child]:pt-0",

...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="press inline-flex h-11 w-11 items-center justify-center rounded-sm border border-line-strong text-text-secondary transition-colors hover:bg-bg-secondary hover:text-text-primary"
    >

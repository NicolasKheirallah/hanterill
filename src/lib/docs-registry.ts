...
export const docLoaders: Record<Locale, Record<string, () => Promise<MDXModule>>> = {
  en: {
    ...
    "get-help": () => import("@/content/docs/get-help.mdx"),
    "common-tasks": () => import("@/content/docs/common-tasks.mdx"),
    ...
    "reading-results": () => import("@/content/docs/reading-results.mdx"),
  ...
  sv: {
    ...
    "installation": () => import("@/content/docs/sv/installation.mdx"),
    ...
    "reading-results": () => import("@/content/docs/sv/reading-results.mdx"),
    ...
    "get-help": () => import("@/content/docs/sv/get-help.mdx"),
    "common-tasks": () => import("@/content/docs/sv/common-tasks.mdx"),

...
export const docs: DocMeta[] = [
  ...
  { slug: "capabilities-and-gating", title: "Capabilities and gating", summary: "How the app decides which features a car supports.", group: "Reference", titleSv: "Kapabiliteter och styrning", summarySv: "Hur appen avgör vilka funktioner ett fordon stöder." },
